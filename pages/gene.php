...
try {
    ...
    $stmt->execute(['specialite' => 'generaliste']);
...
<head>
    ...
    <title>Liste des Médecins en generaliste</title>
...
<body>
    <div class="container">
        <h1>Liste des Médecins en generaliste</h1>
        <?php if (!empty($docteurs)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Aucun médecin trouvé en generaliste.</p>
        <?php endif; ?>
    </div>
</body>
</html>
