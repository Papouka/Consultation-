...
try {
    ...
    $stmt->execute(['specialite' => 'Pediatrie']);
...
<head>
    ...
    <title>Liste des Médecins en Pediatrie</title>
...
<body>
    <div class="container">
        <h1>Liste des Médecins en Pediatrie</h1>
        <?php if (!empty($docteurs)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Aucun médecin trouvé en Pediatrie.</p>
        <?php endif; ?>
    </div>
</body>
</html>
