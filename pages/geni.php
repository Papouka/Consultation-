...
try {
    ...
    $stmt->execute(['specialite' => 'genicologie']);
...
<head>
    ...
    <title>Liste des Médecins en genicologie</title>
...
<body>
    <div class="container">
        <h1>Liste des Médecins en genicologie</h1>
        <?php if (!empty($docteurs)): ?>
            ...
            <?php endforeach; ?>
        <?php else: ?>
            <p>Aucun médecin trouvé en Genicologie.</p>
        <?php endif; ?>
    </div>
</body>
</html>
